          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-neutral-300">Via Creative, 123<br />80100 Napoli, Italia</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-3 text-accent-500 flex-shrink-0" size={18} />
                <a href="tel:+391234567890" className="text-neutral-300 hover:text-accent-500 transition-colors">+39 123 456 7890</a>
              </li>
              <li className="flex items-center">
